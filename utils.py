...
def get_args(is_train=True):
    ...
    parser.add_argument('--num_iter', type=int, default=1500000, help='number of iterations to train for')
    ...
    """ Model Architecture """
    parser.add_argument('--Vim',action='store_true', help='Use end-to-end vim')
